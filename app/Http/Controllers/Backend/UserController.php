...
class UserController extends Controller
{
    ...
    public function authenticate(Request $request)
    {
        ...
        if (Auth::attempt(['username' => $username, 'password' => $password, 'status' => AppHelper::ACTIVE], $remember)) {
            ...
            if(!count($appSettings)){
                $msgType = "warning";
                $msg = "Please update institute information <a href='".route('settings.crm')."'> <b>Here</b></a>";
            }
    ...
    public function reset(Request $request, $token)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if($reset) {
                ...
                $today =  Carbon::now(env('APP_TIMEZONE','Asia/Kolkata'));
    ...
    public function index()
    {
         ...
         $users = User::rightJoin('user_roles', 'users.id', '=', 'user_roles.user_id')
            ...
            ->where('user_roles.role_id', '<>', AppHelper::USER_SUPERADMIN)
    ...
    {
        $roles = Role::where('id', '<>', AppHelper::USER_SUPERADMIN)->pluck('name', 'id');
        $user = null;
        $role = null;
    ...
    public function store(Request $request)
    {
        ...
        if($data['role_id'] == AppHelper::USER_SUPERADMIN){
...
//    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->get('role_id') == AppHelper::USER_SUPERADMIN){
    ...
    public function destroy($id)
    {
         ...
         if($userRole && $userRole->role_id == AppHelper::USER_SUPERADMIN){
    ...
    public function roleUpdate(Request $request, $id)
    {
        ...
        if($id == AppHelper::USER_SUPERADMIN){
        ...
        $permissions = Permission::select('id','name','group')->whereNotIn('group',['SuperAdmin Only','Common'])->orderBy('group','asc')->get();
...
echo "</pre>"; exit; */
    ...
    private function proccessInputPermissions($permissionList, $type, $roleOrUserId, $loggedInUser){
        ...
        $now = Carbon::now(env('APP_TIMEZONE','Asia/Kolkata'));
